	...
	<div class="container align-self-center col-lg-8 border border-info my-5">
		<div class="row">
			<div class="col-lg-6 offset-lg-3 d-flex justify-content-center text-center border-bottom border-info">
				<h2 class="m-3 ">Faculty Details</h2>
			</div>
		</div>
		<div class="row">
			<div class="col">

				<c:set var="fid" scope="session" value="${faculty.facultyID}" />

				<form:form action="" method="post" class="needs-validation m-3"
					modelAttribute="faculty" novalidate="true">
					...
					<c:if test="${fid!=0}">
						<form:hidden path="facultyID" value="${facultyID}" />
					...
					<div class="form-row">
						<div class="form-group col-lg-4">
							...
							<form:input path="college" maxlength="255"
								class="form-control" required="true" />
							<div class="invalid-feedback">Please provide the college name </div>
						</div>
						<div class="form-group col-lg-4">
							<form:label path="degree">Degree</form:label>
							<form:input path="degree" maxlength="255"
								class="form-control" required="true" />
							<div class="invalid-feedback">Please provide the degree </div>
						</div>
						<div class="form-group col-lg-4">
							<form:label path="year">Year of graduation</form:label>
							<form:input path="year" type="number" min="1111" max="3000"
								class="form-control" required="true" />
							<div class="invalid-feedback">Please provide a valid year of graduation </div>
						</div>
					</div>
					...
					<div class="form-row">
						<div class="form-group col-lg-6">
							...
							<form:label path="subject.subjectID" >Subject:</form:label>
							...
							<div class="invalid-feedback">Please select the a valid subject</div>	
						</div>
						<div class="form-group col-lg-6">
							<form:label path="teachingExpirience">Teaching Experience (in years)</form:label>
							<form:input path="teachingExpirience" type="number"
								class="form-control" required="true" />
							<div class="invalid-feedback">Please provide the Teaching Experience </div>
						</div>
					</div>
					...
					<div class="form-group">
						<form:label path="achievement">Achievements</form:label>
						<form:textarea path="achievement" type="textarea"
							class="form-control" maxlength="255" required="true"/>
						<div class="invalid-feedback">Please provide your achievements </div>
					</div>
