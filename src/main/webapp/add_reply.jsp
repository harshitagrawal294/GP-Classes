			...
			<div class="col">
				...
				<form:form action="" method="post" class="needs-validation m-3"
					...
					<div class="form-group">
						...
						<form:input path="name" class="form-control" maxlength="255" required="true"  readonly="true"/>
					</div>
					
					<div class="form-group">
						<form:label path="phoneNumber">Phone Number</form:label>
						<form:input path="phoneNumber" class="form-control" type="number" readonly="true" min="1000000000" max="9999999999" required="true"/>
					</div>
					
					<div class="form-group">
						<form:label path="emailID">Email Address</form:label>
						<form:input path="emailID" class="form-control" type="email" readonly="true" maxlength="255" required="true"/>
					</div>
					...
					<div class="form-group">
						<form:label path="replyGiven">Reply</form:label>
						<form:textarea path="replyGiven" class="form-control" maxlength="1000" required="true"/>
					...
					<div class="row">
						<div class="col-md-6 offset-md-3 text-center">
							<form:button class="btn btn-lg btn-info btn-block bg-success" type="submit">Save</form:button>
						</div>
					</div>
				</form:form>
			</div>
