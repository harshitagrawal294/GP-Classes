		...
		<div class="row">
			<div
				...
				<table class="table table-hover table-bordered table-striped">
					<c:forEach var="batch" items="${enrolledBatch}" varStatus="i">
						<tr>
							<th scope="row">${batch.course.courseName} course</th>
							<td><a href="/student/enrolled/course/${batch.course.courseID}/${batch.session}/${batch.batchID}/">View Details</a></td>
						</tr>				
					</c:forEach>
