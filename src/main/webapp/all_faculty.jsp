				...
				<table class="table table-hover table-bordered table-striped">
					...
					<c:forEach var="faculty" items="${allFaculty}" varStatus="i">
						<tr>
							...
							<td><a href="/${curRole}/faculty/${faculty.employee.user.username}/">View</a></td>	
							<c:if test="${curRole eq 'admin'}">
								<td><a href="/admin/delete/faculty/${faculty.facultyID}/">Delete</a></td>
							</c:if>
						</tr>					
					</c:forEach>
				...
				<div class="col-md-4 offset-md-4 d-flex justify-content-around">
					...
					<c:if test="${curRole eq 'admin'}">
						<a class="btn btn-lg btn-info btn-block  bg-info m-3"
							href="/admin/payment/faculty/">Pay Faculties</a>
					</c:if>
